...
| Category | Technologies / Strengths |
| --- | --- |
...
- **Highlights:** shipment visibility, document workflows, dashboard UX, client/admin-oriented flows
...
- **Highlights:** mobile utility UX, local storage, field productivity workflows, reporting direction
...
- **Signal:** automation-focused backend tooling project

---

## Additional Work

- **Developer Avatar Generator:** deterministic SVG developer avatars through API, CLI, and web UI
- **Money King:** Flutter expense tracker with budgets, cloud sync, passcode, and biometric unlock
...
Open to internships, collaborations, freelance-style product work, and meaningful engineering opportunities where I can build real software, learn fast, and contribute with consistency.
